...
async function getAboutGitHub() {
  try {
    ...
    const resposta = await fetch(
      'https://api.github.com/users/Jbviegas',
    )
      ...
      <article class="about-content">
        ...
        <div class="about-buttons-data">
          ...
          <div class="buttons-container">
            ...
            <a href="./assets/pdf/Curriculo_Desenvolvedor_Full-Stack_Josue.docx.pdf" target="_blank" class="botao-outline">Currículo</a>
          </div>
...
async function getProjectsGitHub() {
  try {
    // Requisição do tipo GET para a API do GitHub
    const resposta = await fetch(
      'https://api.github.com/users/Jbviegas/repos?sort=updated&per_page=6',
    )
